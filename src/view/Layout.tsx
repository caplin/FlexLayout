...
> {
  ...
  render() {
    ...
    if (this.isMainWindow) {
      ...
      reorderedTabMoveables = this.reorderComponents(
        tabMoveables,
        this.orderedTabMoveableIds,
      );
      tabStamps = (
  ...
  renderTabMoveables() {
    ...
    this.props.model.visitNodes((node) => {
      if (node instanceof TabNode) {
        ...
        const renderTab =
          child.isRendered() || (visible && rect.width > 0 && rect.height > 0);
  ...
  public setDragComponent(
    ...
    const dragElement = (
      <div
        ...
        className={
          this.getClassName(CLASSES.FLEXLAYOUT__LAYOUT) +
          ' ' +
