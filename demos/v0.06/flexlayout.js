...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RowNode = __webpack_require__(19);

	var _RowNode2 = _interopRequireDefault(_RowNode);

	var _SplitterNode = __webpack_require__(20);
	...
	var _TabSetNode = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Layout = function (_React$Component) {
	    ...
	    function Layout(props) {
	        ...
	        if (_this.props.model instanceof _Model2.default) {
	            // passed mutable model
	            model = _this.props.model;
	            model.setListener(_this.onModelChange.bind(_this));
	        } else {
	            // passed json representation of node tree, create temporary model for layout
	            model = _Model2.default.fromJson(_this.props.model);
	        }
	        _this.state = { model: model, rect: new _Rect2.default(0, 0, 0, 0) };
	        return _this;
	    }
	    ...
	    _createClass(Layout, [{
	        ...
	        value: function componentWillReceiveProps(newProps) {
	            ...
	            if (newProps.model instanceof _Model2.default) {
	                this.layout(newProps.model);
	                if (this.props.model !== newProps.model) {
	                    if (this.props.model != null && this.props.model instanceof _Model2.default) {
	                ...
	                if (this.props.model !== newProps.model) {
	                    var model = _Model2.default.fromJson(newProps.model);
	                    this.layout(model);
	                }
	            }
	        }
	        ...
	        key: "maximize",
	        value: function maximize(maximizeNode) {
	            this.doAction(_Actions2.default.maximizeToggle(maximizeNode.getId()));
	        }
	    }, {
	        key: "customizeTab",
	...
	Layout.propTypes = {
	    ...
	    model: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.instanceOf(_Model2.default), _react2.default.PropTypes.object]).isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Splitter = function (_React$Component) {
	    ...
	    function Splitter() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Splitter).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Actions = function () {
	    ...
	    _createClass(Actions, null, [{
	        key: "addNode",
	        value: function addNode(json, toNode, location, index) {
	            return { type: Actions.ADD_NODE, json: json, toNode: toNode, location: location.getName(), index: index };
	        }
	    }, {
	        key: "moveNode",
	        value: function moveNode(fromNode, toNode, location, index) {
	            return {
	        ...
	        key: "deleteTab",
	        value: function deleteTab(tabNode) {
	            return { type: Actions.DELETE_TAB, node: tabNode };
	        }
	    }, {
	        key: "renameTab",
	        value: function renameTab(tabNode, text) {
	            return { type: Actions.RENAME_TAB, node: tabNode, text: text };
	        }
	    }, {
	        key: "selectTab",
	        value: function selectTab(tabNode) {
	            return { type: Actions.SELECT_TAB, tabNode: tabNode };
	        }
	    }, {
	        key: "setActiveTabset",
	        value: function setActiveTabset(tabsetNode) {
	        ...
	        key: "maximizeToggle",
	        value: function maximizeToggle(node) {
	        ...
	        value: function updateNodeAttributes(node, attributes) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PopupMenu = function (_React$Component) {
	    ...
	    function PopupMenu(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PopupMenu).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _JsonConverter = __webpack_require__(16);
	...
	var TabNode = function (_Node) {
	    ...
	    function TabNode(model, json) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TabNode).call(this, model));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabSetNode = function (_Node) {
	    ...
	    function TabSetNode(model, json) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TabSetNode).call(this, model));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RowNode = function (_Node) {
	    ...
	    function RowNode(model, json) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RowNode).call(this, model));
	    ...
	    _createClass(RowNode, [{
	        key: "_layout",
	        value: function _layout(rect) {
	            _get(Object.getPrototypeOf(RowNode.prototype), "_layout", this).call(this, rect);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SplitterNode = function (_Node) {
	    ...
	    function SplitterNode(model) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SplitterNode).call(this, model));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Model = function () {
	    ...
	    _createClass(Model, [{
	        ...
	        key: "apply",
	        value: function apply(action, json) {
