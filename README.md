...
[Screenshot of Caplin Liberator Explorer using FlexLayout](https://rawgit.com/caplin/FlexLayout/demos/demos/v0.20/images/LiberatorExplorerV3_2.PNG)

[Run the Demo](https://rawgit.com/caplin/FlexLayout/demos/demos/v0.20/demo/index.html)

Try it now using [JSFiddle](https://jsfiddle.net/rmf3hzmf/13/)
